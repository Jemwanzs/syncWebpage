    ...
    <footer className="bg-primary text-primary-foreground">
      <div className="section-container px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 text-center md:text-left">
          ...
          {/* Product */}
          <div>
            <h4 className="font-heading font-bold mb-4 text-sm uppercase tracking-wide text-primary-foreground/40">
              Product
            </h4>
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <ul className="space-y-3 text-sm text-primary-foreground/70">
              ...
              <li className="flex items-center gap-2 justify-center md:justify-start">
                <Mail size={14} /> james@syncscore.io
              </li>

              <li className="flex items-center gap-2 justify-center md:justify-start">
                <Phone size={14} /> +254 758 462 513
              </li>

              <li className="flex items-center gap-2 justify-center md:justify-start">
                <Phone size={14} /> +254 798 993 404
              </li>
            </ul>
          </div>
